...
// to avoid duplicate version and double patching, use env variable to avoid it
if (process.env.REQUEST_LOCAL_PATCHED) {
    return;
}
process.env.REQUEST_LOCAL_PATCHED = 'true';
